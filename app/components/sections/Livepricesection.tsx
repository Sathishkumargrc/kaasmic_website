      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 mb-8 sm:mb-10 lg:mb-12">
          ...
          <motion.div
            ...
            className={`cursor-pointer rounded-xl sm:rounded-2xl p-6 sm:p-8 border-2 transition-all ${
              activeTab === "gold" 
          ...
          >
            ...
            <div className="flex items-baseline gap-2 sm:gap-3 flex-wrap">
              ...
              <span className={`text-sm sm:text-base lg:text-lg font-semibold px-2 sm:px-3 py-1 rounded-full ${
